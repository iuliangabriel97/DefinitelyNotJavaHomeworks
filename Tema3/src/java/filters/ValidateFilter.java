 ...
 * @author roungureanu
 */
@WebFilter(filterName = "ValidateFilter", urlPatterns = {"/InputControllerServlet"}, 
        initParams = {@WebInitParam(name="defaultCategory", value="first")})
public class ValidateFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        {
            log("Will redirect request");
            log("Default category is " + this.defaultCategory);
            resp.sendRedirect("InputControllerServlet");
            return;
        }
        
        if (req.getMethod().equals("POST") && (category == null || category.equals("") || category.equals("none")))
        {
